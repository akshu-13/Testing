 ...
 WebDriver driver;
   ...
   @BeforeTest
    public void before() throws Exception{
        ExtentSparkReporter exsprk = new ExtentSparkReporter("C:\\Users\\aksha\\Desktop\\que 9\\hybridlab\\report1.html");
    ...
    public void test1() throws Exception
    {
        ...
        PropertyConfigurator.configure("C:\\Users\\aksha\\Desktop\\demo\\demo\\que 9\\hybridlab\\hybrid\\src\\test\\java\\com\\example\\log4j.properties");

        FileInputStream fs = new FileInputStream("C:\\Users\\aksha\\Desktop\\demo\\demo\\que 9\\hybridlab\\data.xlsx");
    ...
    public void afterTest(ITestResult result) throws Exception{
        if(result.getStatus()==ITestResult.FAILURE)
        {
            ...
            String path = "C:\\Users\\aksha\\Desktop\\demo\\demo\\que 9\\hybridlab"+result.getName()+"png";
        ...
        File screenshot = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        String path = "C:\\Users\\aksha\\Desktop\\testing\\Day 11\\Day 11\\sec1logandreport"+result.getName()+"png";
        FileUtils.copyFile(screenshot,new File(path));
        test.addScreenCaptureFromPath(path);
        }
        reports.flush();
